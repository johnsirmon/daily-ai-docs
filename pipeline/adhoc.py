...
def write_brief(request: PodcastRequest, packet: dict, directory: Path) -> Path:
    ...
    lines = [
        ...
        "Use English Deep Dive / Longer. Aim for 20-30 minutes as an editorial target, not a publication limit.",
        "A shorter or longer recording is acceptable when substantive, source-backed, and fully reviewed.",
