...
| Repo | Version | Date |
|------|---------|------|
| [microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel/releases/tag/vectordata-dotnet-10.0.0) | `vectordata-dotnet-10.0.0` | 2026-02-19 |
| [microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel/releases/tag/dotnet-1.72.0) | `dotnet-1.72.0` | 2026-02-19 |
| [microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel/releases/tag/dotnet-1.71.0) | `dotnet-1.71.0` | 2026-02-16 |
| [BerriAI/litellm](https://github.com/BerriAI/litellm/releases/tag/v1.81.12-stable.2) | `v1.81.12-stable.2` | 2026-02-28 |
| [BerriAI/litellm](https://github.com/BerriAI/litellm/releases/tag/v1.81.6.rc.6) | `v1.81.6.rc.6` | 2026-02-28 |
| [BerriAI/litellm](https://github.com/BerriAI/litellm/releases/tag/v1.81.14.rc.2) | `v1.81.14.rc.2` | 2026-02-27 |
| [BerriAI/litellm](https://github.com/BerriAI/litellm/releases/tag/litellm_presidio-dev-v1.81.16) | `litellm_presidio-dev-v1.81.16` | 2026-02-27 |
| [BerriAI/litellm](https://github.com/BerriAI/litellm/releases/tag/v1.81.16.custm-auth.dev) | `v1.81.16.custm-auth.dev` | 2026-02-26 |
| [BerriAI/litellm](https://github.com/BerriAI/litellm/releases/tag/1.81.16-nightly) | `1.81.16-nightly` | 2026-02-26 |
| [BerriAI/litellm](https://github.com/BerriAI/litellm/releases/tag/v1.81.15-nightly) | `v1.81.15-nightly` | 2026-02-24 |
| [BerriAI/litellm](https://github.com/BerriAI/litellm/releases/tag/v1.81.12-stable_gpt-5.3) | `v1.81.12-stable_gpt-5.3` | 2026-02-24 |
| [BerriAI/litellm](https://github.com/BerriAI/litellm/releases/tag/v1.81.12-stable.1) | `v1.81.12-stable.1` | 2026-02-24 |
| [BerriAI/litellm](https://github.com/BerriAI/litellm/releases/tag/v1.81.6.rc.5) | `v1.81.6.rc.5` | 2026-02-24 |
...
| Repo | Stars | Description |
|------|-------|-------------|
| [jlcodes99/vscode-antigravity-cockpit](https://github.com/jlcodes99/vscode-antigravity-cockpit) | ⭐ 3,484 | VS Code extension for monitoring Google Antigravity AI quotas. Features Webview dashboard, QuickPick mode, and quota grouping. |
| [specstoryai/getspecstory](https://github.com/specstoryai/getspecstory) | ⭐ 1,084 | Install our local first extensions for your favorite AI IDE or Terminal Agent. Sync your conversations to the cloud. File issues and requests. |
| [AltimateAI/vscode-dbt-power-user](https://github.com/AltimateAI/vscode-dbt-power-user) | ⭐ 560 | This extension makes vscode seamlessly work with dbt™: Auto-complete, preview, column lineage, AI docs generation, health checks, cost estimation etc |
| [Tiledesk/design-studio](https://github.com/Tiledesk/design-studio) | ⭐ 445 | Tiledesk's open-source visual, no-code designer where LLM/GPT AI meets a flexible 'graph' approach. Create conversations and automations effortlessly – a Voiceflow and Botpress alternative. |
| [matlab/matlab-mcp-core-server](https://github.com/matlab/matlab-mcp-core-server) | ⭐ 190 | Run MATLAB® using AI applications with the official MATLAB MCP Server from MathWorks®. This MCP server for MATLAB supports a wide range of coding agents like Claude Code® and Visual Studio® Code. |

### 🚀 Recent Releases

| Repo | Version | Date |
|------|---------|------|
| [microsoft/vscode](https://github.com/microsoft/vscode/releases/tag/1.109.5) | `1.109.5` | 2026-02-20 |
